...
def _initial_token() -> str:
    ...
    """
    original = {"uid": "", "timestamp": 0, "token": "",
                "client": "web", "version": "", "language": "en"}
...
if __name__ == "__main__":
    ...
    try:
        cfg = client_from_env()
        token = crosslogin(cfg["account"], cfg["password"],
                           cfg["region"])  # token pós-login
